...
import User from "./components/User/Search";
    ...
    <div className="">
      <div className={darkTheme ? "dark" : "light"}>
        <div className="nav container">
          <h1 style={{ fontSize: "26px" }} className="logo">
            devfinder
          </h1>
        ...
        <div className="content">
          <User handleSearch={handleSearch} loading={loading} />
          <Card data={user} error={error} loading={loading} />
        </div>
      </div>
    </div>
  );
